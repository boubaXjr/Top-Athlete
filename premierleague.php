...
<head>
    ...
    <title>Maillots Premier League</title>
...
<div class="container my-4">
    <div class="list-group">
        <a href="premierleague.php" class="list-group-item list-group-item-action active">Premier League</a>
        ...
        <a href="seria.php" class="list-group-item list-group-item-action">Serie A</a>
    </div>
</div>
...
<div class="container my-4">
    ...
    $teams = ['Manchester City', 'Arsenal', 'Liverpool', 'Tottenham', 'Chelsea', 'Manchester United'];
